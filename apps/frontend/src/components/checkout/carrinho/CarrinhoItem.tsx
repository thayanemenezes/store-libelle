...
export default function CarrinhoItem(props: CarrinhoItemProps) {
    ...
    return (
        <div className="flex items-center text-pink-950 px-8 py-0 rounded-xl gap-16">
            <Image
                src={produto.imagem}
                width={200}
                height={0}
            ...
            <div className="flex flex-col items-center gap-4">
                <span className="text-sm text-pink-400">Quantidade</span>
                <div className="flex items-center border border-zinc-300 rounded-lg">
                    ...
                    <button 
                    type='submit'
                        className="px-2 py-0.5 text-pink-900"
            ...
            <div className="flex flex-col items-end">
                ...
                <div className="flex gap-1.5 items-baseline">
                    ...
                    <span className="text-pink-900 text-xl font-semibold">
