...
export default function Rodape() {
    return (
        <footer className="flex flex-col  text-pink-900 mt-10">
            <div className="h-px bg-gradient-to-r from-pink-600/20 via-pink-600/80 to-pink-600/20"/>
            <div className="container flex flex-col py-10 gap-10">
                ...
                <div className="flex flex-col md:flex-row items-center gap-1.5 text-sm text-zinc-500 m-auto">
